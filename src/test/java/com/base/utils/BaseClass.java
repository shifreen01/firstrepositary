...
//		wait.until(ExpectedConditions.visibilityOf(element));
	...
	public static void loggingInformation(String info1, String info2, String info3, String info4, String info5,
			String info6) throws Exception {
		reportStatus("Info", info1);
		reportStatus("Info", info2);
		reportStatus("Info", info3);
		reportStatus(info4, "Test scenario information");
		reportStatus(info5, info6);
